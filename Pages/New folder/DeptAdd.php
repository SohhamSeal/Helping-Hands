<?php
  ...
  if (isset($_POST['submit'])) 
  {
    ...
    if ($result2 and $result1) 
      {
        echo "<script>alert('New Employee has been added to the table!!')</script>";
      }
    else
    {
    ...
    <section class="u-clearfix u-palette-3-light-3 u-section-1" id="sec-0b4f">
      <div class="u-clearfix u-sheet u-sheet-1">
          <!--<div class="container">
            ...
            <p class="Employee" style="font-size: 2rem; font-weight: 800;">&nbsp;&nbsp;&nbsp;NEW VOLUNTEER DETAILS&nbsp;&nbsp;&nbsp;</p>
            ...
            <div class="input-group">
              <button type="submit" name="submit" class="btn">Add Employee</button>&nbsp;&nbsp;&nbsp;&nbsp;<button type="reset" name="Reset" class="btn">Reset</button>
            </div>
          </form>
        </div>-->
        <div><br><br><br><br></div>
