...
if (isset($_POST['submit'])) {
  ...
  if (!$result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
      mysqli_query($conn, "delete from employee where EID='$EmpID'");
      echo "<script>alert('Employee record deleted!')</script>";
    }
  }
}
?>
    ...
    <div class="u-clearfix u-sheet u-sheet-1">
      ...
      <div class="Question">
        <form method="POST">
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-danger" name="submit">Delete
      </div>
      </form>
    </div>
  </section>
